...
# Gives access to a variable called "session" which is used to keep values for a particular user
...
# independent to each other, we don't have one global notes variable shared among all users.
